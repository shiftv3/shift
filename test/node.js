...
node.blockTime = 30000; // Block time in miliseconds
node.blockTimePlus = 32000; // Block time + 2 seconds in miliseconds
...
node.randomAccount = function () {
	...
	account.publicKey = node.shiftsk.crypto.getKeys(account.password).publicKey;
	account.address = node.shiftsk.crypto.getAddress(account.publicKey);
